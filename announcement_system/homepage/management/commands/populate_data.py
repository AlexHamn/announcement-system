      ...
      subcategories = [
        {
          ...
          'template_ru': 'Внимание, пассажиры. Рейс [flight number] из [origin] в [destination] прибывает на Гейт [gate number]. Просьба пройти к указанному гейту для посадки.',
        ...
        },
        {
          ...
          'template_ru': 'Заканчивается посадка на Рейс [flight number] в [destination]. Все оставшиеся пассажиры, просьба немедленно пройти к Гейту [gate number]. Гейт закроется через [time remaining].',
        ...
        },
        {
          ...
          'template_ru': 'Внимание, пассажиры. Рейс [flight number] в [destination] задерживается из-за [reason]. Новое расчетное время вылета - [new time]. Приносим извинения за неудобства.',
        ...
        },
        {
          ...
          'template_ru': 'Дамы и господа, мы с сожалением сообщаем, что Рейс [flight number] в [destination] отменен по причине [reason]. Просьба обратиться к стойке авиакомпании для повторного бронирования или возврата.',
        ...
        },
        {
          ...
          'template_ru': 'Внимание, пассажиры. Из-за [weather condition or emergency] все рейсы временно приостановлены. Просьба оставаться в специально отведенных зонах и следовать указаниям персонала аэропорта для вашей безопасности.',
        ...
        },
        {
          ...
          'template_ru': 'Внимание, пассажиры. [description of item] нашли в [location] на территории аэропорта. Если эта вещь принадлежит вам, просьба обратиться на стойку находок с соответствующим удостоверением личности.',
          'template_kg': 'Жолоочулар, көңүлүңүздү бурабыз. [description of item] аэропорт аймагындагы [location] жерде табылды. Эгер бул буюм сизге таандык болсо, тиешелүү документ менен Жоголгон жана Табылган нерселер столуна барыңыз.',
        },
        {
          'category': 'Lost and Found Announcements',
          'name': 'Lost Item',
          ...
          'template_ru': 'Это объявление для владельца [description of item], найденного в [location]. Если вы потеряли эту вещь, просьба немедленно обратиться на стойку находок.',
        ...
        },
        {
          ...
          'template_ru': 'Это объявление для пассажиров Рейса [flight number] в [destination]. Ваш рейс был переведен на Гейт [new gate number]. Просьба незамедлительно пройти к новому гейту.',
          'template_kg': 'Бул [flight number] рейсине [destination] шаарына жолоочулар үчүн. Сиздин учуш [new gate number]-тарзга кайта багытталды. Зарыл болсо, дароо жаңы тарзга өтүңүз.',
        },
        {
          'category': 'Baggage Claim Announcements',
          'name': 'Baggage Available',
          'template': 'Attention, passengers. Baggage from Flight [flight number] from [origin] is now available for pickup at the conveyour belt number [carousel number].',
          'template_ru': 'Внимание, пассажиры. Багаж с Рейса [flight number] из [origin] сейчас доступен для получения на конвеерной ленте номер [carousel number].',
          'template_kg': 'Жолоочулар, көңүлүңүздү бурабыз. [origin] шаарынан келген [flight number] рейсинин багажы азыр [carousel number]-караусел үстүндө алынышы мүмкүн.',
        },
        {
          'category': 'Baggage Claim Announcements',
